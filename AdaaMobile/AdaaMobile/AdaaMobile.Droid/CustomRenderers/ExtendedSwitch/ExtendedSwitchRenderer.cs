...
using AdaaMobile.Droid.CustomRenderers.ExtendedSwitch;
...
namespace AdaaMobile.Droid.CustomRenderers.ExtendedSwitch
{
	...
	/// </summary>
	public class ExtendedSwitchRenderer : ViewRenderer<Controls.ExtendedSwitch, Switch>
	{
		/// <summary>
