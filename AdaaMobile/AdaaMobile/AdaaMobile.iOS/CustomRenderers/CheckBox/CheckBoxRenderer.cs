...
using AdaaMobile.iOS.CustomRenderers.CheckBox;
...
namespace AdaaMobile.iOS.CustomRenderers.CheckBox
{
    ...
    /// </summary>
    public class CheckBoxRenderer : ViewRenderer<Controls.CheckBox, CheckBoxView>
    {
        /// <summary>
        ...
        private void ResizeText()
        {
            ...
            if (Math.Abs(supportedLines - requiredLines) > 1e-6)
            {
