...
namespace AdaaMobile.Views
{
	public partial class ProfilePage : ContentPage
	{
		...
		{
			InitializeComponent ();
			var _viewModel = Locator.Default.DirectoryViewModel;
			if (_viewModel.SelectedEmployee != null) {
				_profileViewModel = Locator.Default.ProfileViewModel;
				_profileViewModel.SetOtherUserId (_viewModel.SelectedEmployee.UserId);
				GetUserProfile (_viewModel.SelectedEmployee.UserId);
